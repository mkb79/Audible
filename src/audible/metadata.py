...
def raw_xxtea(v: List, n: int, k: Union[List, Tuple]):
...
def _bytes_to_long_list(data: Union[str, bytes]) -> List[int]:
...
def _longs_to_bytes(data: List[int]) -> bytearray:
...
class XXTEA:
    ...
    def encrypt(self, data: Union[str, bytes]) -> bytes:
        ...
        idata = _bytes_to_long_list(data)
