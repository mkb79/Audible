...
class TestStatusError:
    ...
    def test_status_error_with_empty_dict(self):
...
class TestNotResponding:
    ...
    def test_not_responding_inherits_from_request_error(self):
...
class TestNetworkError:
    ...
    def test_network_error_inherits_from_request_error(self):
...
class TestHTTPStatusExceptions:
    ...
    def test_unexpected_error_inheritance(self):
...
class TestAuthFlowError:
    ...
    def test_auth_flow_error_message(self):
...
class TestNoRefreshToken:
    ...
    def test_no_refresh_token_message(self):
...
class TestFileEncryptionError:
    ...
    def test_file_encryption_error_message(self):
...
class TestExceptionRaising:
    ...
    def test_status_error_can_be_raised_and_caught(self):
    ...
    def test_not_responding_can_be_raised_and_caught(self):
